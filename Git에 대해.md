...
[벨로그7](https://velog.io/@kwonh/Git-Rebase%EB%9E%80)
...
## Git과 GitHub의 차이점
Git은 위에서 말했던 버전 관리 시스템을 사용하기 때문에 **코드의 변경 사항을 확인하고, 이전 버전으로 되돌리기가 가능합니다.** 그리고 GitHub는 **Git 저장소를 온라인에 업로드하고, 다른 사람들과 협업을 할 수 있게 해줍니다.**

Git은 로컬 컴퓨터에서 사용하기 때문에 인터넷이 필요없고, GitHub는 그와 반대로 웹(클라우드)에서 사용을 합니다.

주로 Git은 개발을 할때 버전 관리 시스템을 이용하기 위해 사용하고, GitHub는 다른 사람들과 코드를 공유하여 협업을 하기 위해서 사용합니다.
...
![깃배쉬](./Images/Git/git_bash.png)
**여기서 Open Git Bash here을 체크해주시면 되겠습니다.**<br>

## Git 기본 명령어들
![깃배쉬1](./Images/Git/git_bash_1.png)
<br>
...
Rebase는 현재 브랜치의 커밋들을 지정한 브랜치에 다시 적용을 합니다.

Merge와는 다르게 커밋 히스토리가 여러 갈래로 있는것이 아닌 한 줄로 깔끔하게 정리가 됩니다.
<br>
**커밋 기록을 깔끔하게 관리하고 싶을때 Merge 대신에 Rebase를 쓰면 됩니다.**

그러나 Rebase는 다른 사람이 이미 pull을 한 브랜치에서 사용하면 충돌이 일어날 수 있습니다.
<br>
**그래서 협업 중인 브랜치에서는 Merge, 개인 작업을 정리할 땐 Rebase를 사용하는 것이 좋습니다.**
